...
class TestPaymentProcessor(unittest.TestCase):
    ...
    def test_valid_amount(self):
        '''
        test_valid_amount testcase test that the amount is valid or not.
        '''
    ...
    def test_zero_amount(self):
        '''
        test_zero_amount testcase test that the amount is zero.
        '''
    ...
    def test_negative_amount(self):
        '''
        test_negative_amount testcase test that the amount is negative.
        '''
        with self.assertRaises(ValueError):
    ...
    def test_exceed_limit(self):
        '''
        test_exceed_amount testcase test if the amount exceeds the limit.
        '''
        with self.assertRaises(ValueError):
    ...
    def test_fee_rounding(self):
        '''
        test_fee_rounding testcase test that the outcome
